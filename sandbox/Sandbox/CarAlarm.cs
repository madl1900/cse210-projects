...
public class Car
{
    ...
    public void Run()
    {
        ...
        while (IsRunning)
        {
            ...
            else if (input == "6") clicker.IsPanic = true;
            else if (input == "7") clicker.IsPanic = false;
    ...
    public void PrintMenu()
    {
        ...
        Console.WriteLine("6. Turn on Panic Button");
        Console.WriteLine("7. Disable Panic Button");
    }
}
